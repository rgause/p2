...
class TenantResourceIT {
    ...
    public static Tenant createEntity(EntityManager em) {
        Tenant tenant = new Tenant().name(DEFAULT_NAME).active(DEFAULT_ACTIVE).provisioned(DEFAULT_PROVISIONED);
        return tenant;
    }
    ...
    public static Tenant createUpdatedEntity(EntityManager em) {
        Tenant tenant = new Tenant().name(UPDATED_NAME).active(UPDATED_ACTIVE).provisioned(UPDATED_PROVISIONED);
        return tenant;
    }
    ...
    void putNewTenant() throws Exception {
        ...
        updatedTenant.name(UPDATED_NAME).active(UPDATED_ACTIVE).provisioned(UPDATED_PROVISIONED);
    ...
    void partialUpdateTenantWithPatch() throws Exception {
        ...
        partialUpdatedTenant.name(UPDATED_NAME).provisioned(UPDATED_PROVISIONED);
    ...
    void fullUpdateTenantWithPatch() throws Exception {
        ...
        partialUpdatedTenant.name(UPDATED_NAME).active(UPDATED_ACTIVE).provisioned(UPDATED_PROVISIONED);
