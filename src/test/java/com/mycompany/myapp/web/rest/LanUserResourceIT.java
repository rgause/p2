...
class LanUserResourceIT {
    ...
    public static LanUser createEntity(EntityManager em) {
        LanUser lanUser = new LanUser().active(DEFAULT_ACTIVE).lanId(DEFAULT_LAN_ID).pwpId(DEFAULT_PWP_ID);
        return lanUser;
    }
    ...
    public static LanUser createUpdatedEntity(EntityManager em) {
        LanUser lanUser = new LanUser().active(UPDATED_ACTIVE).lanId(UPDATED_LAN_ID).pwpId(UPDATED_PWP_ID);
        return lanUser;
    }
    ...
    void putNewLanUser() throws Exception {
        ...
        updatedLanUser.active(UPDATED_ACTIVE).lanId(UPDATED_LAN_ID).pwpId(UPDATED_PWP_ID);
    ...
    void partialUpdateLanUserWithPatch() throws Exception {
        ...
        partialUpdatedLanUser.active(UPDATED_ACTIVE);
    ...
    void fullUpdateLanUserWithPatch() throws Exception {
        ...
        partialUpdatedLanUser.active(UPDATED_ACTIVE).lanId(UPDATED_LAN_ID).pwpId(UPDATED_PWP_ID);
